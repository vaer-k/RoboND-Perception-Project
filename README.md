...
I applied this processing pipeline to each of three test datasets, and was able to successfully identify the objects in each scene. Below are images from each test set with clearly labeled objects generated by this pipeline. 
